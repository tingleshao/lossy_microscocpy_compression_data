...
for test = 3:10
 ...
 %       the_comp_data_debug_dir = [comp_data_dir, '/real_0', num2str(test), '_debug/dilate_', num2str(dilate),'/'];
        ...
        if ~exist(save_exp_data_dir_full,'dir')
            ...
            video_data = read_syn_video_data(the_noisy_data_dir, num_of_frames);
            ...
            % from 0)
            mb_qp_add_noise_back_2(noise_stats, the_comp_data_dir, the_comp_data_code_file_name, num_of_frames, save_exp_data_dir_full, w, h);
        else
